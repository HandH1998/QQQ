...
import typing
import tqdm
from QQQ.utils import get_model_architecture, get_transformer_layers, get_pre_head_layernorm, get_lm_head, get_embeddings, free_memory, str2torch_device
...
def rotate_model(model, args, Q=None):
    ...
    Q = get_orthogonal_matrix(model.config.hidden_size, args.rotate_mode, device) if Q is None else Q
    config = model.config
